        ...
        private static ScriptTemplate StandardChessFile(Project project, EventFile script)
        {
            ...
            new TemplateSection("SCRIPT00", CommandsPosition.TOP,
                ...
                new ScriptItemCommand(CommandVerb.DIALOGUE,
                    ...
                    new DialoguePropertyScriptParameter("Text Voice Font", project.MessInfo.MessageInfos.First(m => m.Character == Speaker.UNKNOWN)),
                    new DialoguePropertyScriptParameter("Text Speed", project.MessInfo.MessageInfos.First(m => m.Character == Speaker.UNKNOWN)),
