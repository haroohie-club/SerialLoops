                ...
                case CommandVerb.DIALOGUE:
                    switch (i)
                    {
                        ...
                        case 1:
                            ...
                            break;
                        case 2:
                            parameters.Add(new SpritePreManipScriptParameter(localize("Sprite Entrance Transition"), parameter));
                            break;
                        case 3:
                            parameters.Add(new SpritePostManipScriptParameter(localize("Sprite Exit/Move Transition"), parameter));
                            break;
                        case 4:
